...
public class WinningStrategyImpl implements WinningStrategy {
    ...
    public void undo(Board board ,Move move){
        ...
        Map<Symbol, Integer> updatedmaps = rowMaps.get(row);
        updatedmaps.put(symbol,updatedmaps.get(symbol)-1);

        Map<Symbol, Integer> updatedmaps1 = colMaps.get(col);
        updatedmaps.put(symbol,updatedmaps1.get(symbol)-1);
