...
public class TestTicketController {
    ...
    public void testIssueTicketWith3Floors2CarsOn1stAnd2ndFloorAnd1On3rdFloor(){
        ParkingLot parkingLotOriginal = insertDummyData(3, Map.of(VehicleType.CAR, 2), 1, 1, "Bangalore");
        System.out.println("Original "+ parkingLotOriginal);
        GenerateTicketRequestDto requestDto = new GenerateTicketRequestDto();
        requestDto.setGateId(1);
        requestDto.setRegistrationNumber("KA-01-HH-1234");
        requestDto.setVehicleType("CAR");
        ...
        System.out.println("Original Tc1"+ parkingLotOriginal);
        ...
        System.out.println("Original Tc2"+ parkingLotOriginal);
        ...
        System.out.println("Original Tc3"+ parkingLotOriginal);
        ...
        System.out.println("Original Tc4"+ parkingLotOriginal);
        ...
        assertEquals(responseDto.getResponseStatus(), ResponseStatus.SUCCESS, "Response status should be success");
        assertNotNull(responseDto.getTicket(), "Ticket should not be null"); //Lead to 2nd floor
        System.out.println("Original Tc5"+ parkingLotOriginal);
        ...
        System.out.println("Original Tc6"+ parkingLotOriginal);
    ...
    public ParkingLot insertDummyData(int numOfFloors, Map<VehicleType, Integer> numOfSpotsPerVehicleTypePerFloor, int numOfEntryGates, int numOfExitGates, String address) {
